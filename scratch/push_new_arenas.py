...
log_path = os.path.join(cwd, "scratch", "push_arenas_log.txt")
...
run_cmd(["git", "add", "."])
run_cmd(["git", "commit", "-m", "Feat: Them 3 phan mon Dau truong (Tin hoc tre, VnEdu, Trang Nguyen Tieng Viet)"])
run_cmd(["git", "push", "origin", "main"])

with open(log_path, "w", encoding="utf-8") as f:
    f.write("\n".join(logs))

print("PUSH ARENAS COMPLETED")
